<template>
  <ToolWorkspace v-model="activeTab" :tabs="TABS" accent="#3b7de0">
    <el-alert v-if="!apiReady" type="warning" show-icon class="helper-hint" :closable="false"> 请在桌面客户端内使用，浏览器预览无法访问本地系统信息。 </el-alert>
...
const activeTab = useInitialTab(TABS, () => props.initialTab, 'startup')
