...
export const RESULT_ROUTES = [
  ...
  { id: 'excel/profile', tool: 'excel', feature: 'profile', label: 'Excel 数据质检', description: '检查单份工作簿的缺失值、字段分布并导出质量报告。', extensions: ['xlsx', 'xlsm', 'xltx', 'xltm'], capability: { maximumAssets: 1 } },
  { id: 'excel/process', tool: 'excel', feature: 'process', label: '清洗 Excel', description: '对单份工作簿去空格、去重、分组与排序，输出新文件。', extensions: ['xlsx', 'xlsm', 'xltx', 'xltm'], capability: { maximumAssets: 1 } },
  { id: 'excel/split', tool: 'excel', feature: 'split', label: '拆分 Excel', description: '按指定字段将单份工作簿拆为多个文件。', extensions: ['xlsx', 'xlsm', 'xltx', 'xltm'], capability: { maximumAssets: 1 } },
